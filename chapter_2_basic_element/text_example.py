...
class WriteText(Scene):
    """An example for text writing in the video."""
    def construct(self) -> None:
        text = TextMobject("BackSpace")
        self.play(Write(text)) # Just Write it.
        self.wait()
        return None
...
class BraceAnnotation(Scene):
    def construct(self):
        ...
        self.play(ShowCreation(line), ShowCreation(dot), ShowCreation(dot2), ShowCreation(b1), ShowCreation(b2), ShowCreation(b1text), ShowCreation(b2text))
        self.wait()
